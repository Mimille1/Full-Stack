    ...
    <div class="container">
        ...
        <form class="text-white" action="commande_script.php" id="commande" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-check w-100 " name="NomPrenom" id="NomPrenom" placeholder="Saisir votre nom et prénom">
            ...
            <div class="form-row">
                ...
                <div class="col-5 ">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" name="courriel" id="courriel" placeholder="Saisir votre Email">
                ...
                <div class="col-5 ml-auto">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="numero" id="numero" placeholder="Saisir votre numéro de téléphone">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-check w-100 " name="adresse" id="adresse" placeholder="Saisir votre adresse">
