        ...
        <form action="add_script.php" id='vinyle' method='post'>
            <div class="form-check">
                ...
                <div class='form-row'>
                    ...
                    <input type="text" class='form-control' name="genre" id='genre' placeholder='enter genre (Rock, Pop, Prog, ...'>
                    <span id='genreError'></span>
                </div>

                <div class='form-row'>
                    <label for="label">Label</label>
                    <input type="text" class='form-control' name="label" id='label' placeholder='enter label (EMI, Warner, Polygram, Univers sale, ...'>
                    <span id='genreError'></span>
                </div>
                ...
                <div class='form-row'>
                    ...
                    <input type="file" class='form-control' name="picture" id='picture' accept="image/png, image/jpeg, image/webp">
